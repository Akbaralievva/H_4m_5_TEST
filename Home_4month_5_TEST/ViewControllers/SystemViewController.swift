...
class SystemViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    private lazy var generalStackBtn: UIButton = MakerView().makerButton(title: "General", titleColor: .black)
    
    private lazy var f_bottomLineLbl: UILabel = MakerView().makerLabel(text: "______________________", size: 14, weight: .bold, textColor: .black)
    ...
    private lazy var systemStackBtn: UIButton = MakerView().makerButton(title: "System", titleColor: .red)
    
    private lazy var s_bottomLineLbl: UILabel = MakerView().makerLabel(text: "______________________", size: 14, weight: .bold, textColor: .red)
    ...
    private func setUpUI(){
        ...
        NSLayoutConstraint.activate([
            second_stackView.topAnchor.constraint(equalTo: setting_icImg.bottomAnchor, constant: 26),
        ...
        generalStackBtn.addTarget(self, action: #selector(generalStackBtnIsTapped), for: .touchUpInside)
    }
    ...
    @objc func generalStackBtnIsTapped() {
